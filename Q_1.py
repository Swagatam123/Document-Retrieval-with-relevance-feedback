...
def tsne_plot(query_vector):
    ...
    plt.plot([0,x[0]],[0,y[0]],label=" query vector")
    plt.plot([0,x[1]],[0,y[1]],label="relevance document")
    plt.plot([0,x[2]],[0,y[2]],label="non relevanve document")
    plt.xlabel("x1")
    plt.ylabel("x2")
    plt.legend()
    plt.axis('equal')
...
while(c!=0):
    ...
    query_vector=rochio_algorithm(query_vector,relevance_vocab_dict,nonrelevance_vocab_dict)

    print(query_vector)
    plot_vector=[]
    plot_vector.append(query_vector)
    plot_vector.append(relevance_vector)
    plot_vector.append(nonrelevance_vector)
